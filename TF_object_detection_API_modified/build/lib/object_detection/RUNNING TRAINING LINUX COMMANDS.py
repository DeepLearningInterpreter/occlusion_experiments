...
SET MODEL_DIR='Martijn/multitude of possible detectors/model1'
SET NUM_TRAIN_STEPS=50000
SET SAMPLE_1_OF_N_EVAL_EXAMPLES=1

python model_main.py ^
    --pipeline_config_path="Martijn\multitude_of_possible_detectors\training\model2\pipeline.config" ^
    --model_dir="Martijn\multitude_of_possible_detectors\training\model2" ^
